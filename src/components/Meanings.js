    ...
    <section className="meanings__container">
      ...
      <ul>
        {props.definitions.map((item) =>
          item.example ? (
            <li className="meanings__defenition">
              {item.definition}
              <div className="meanings__example">{item.example}</div>
            </li>
          ) : (
            <li className="meanings__defenition">{item.definition}</li>
          )
        )}
      </ul>
      {props.synonyms.length ? (
        <div className="meanings__synonyms-container">
          ...
          <div className="meanings__synonyms">
            {props.synonyms.map((item) => (
              <span className="meanings__synonym">{item}</span>
            ))}
          </div>
        </div>
      ) : (
